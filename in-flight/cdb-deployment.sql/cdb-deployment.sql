...
CREATE USER c##cfltuser IDENTIFIED BY Confluent12! DEFAULT TABLESPACE xstream_tbs QUOTA UNLIMITED ON xstream_tbs CONTAINER=ALL;;
-- Grant privileges
...
--GRANT SELECT ON ORDERMGMT.EMPLOYEES TO c##cfltuserser;
