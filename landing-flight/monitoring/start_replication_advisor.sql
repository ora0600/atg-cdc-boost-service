-- The Xstream replication performance advisor belongs to XStream license which you will get from Confluent in XStream Connector
-- To be 100% sure please ask your Oracle Salesrep.
-- Install advisor
...
-- One-off snapshot: collect stats 10 times every 60 seconds
SQL> SET SERVEROUTPUT ON
SQL> BEGIN
  UTL_RPADV.COLLECT_STATS(
    interval   => 60,     -- seconds between runs (max 3600)
    num_runs   => 10      -- number of samples
    -- leave other thresholds default unless you need to tune them
  );
END;
/
...
--
--OUTPUT
--PATH 1 RUN_ID 1 RUN_TIME 2025-AUG-13 12:10:24 CCA N|<C> CONFLUENT_XOUT1 5.2 0.8 0 LMP (0) CAP 0% "" |<Q> "C##GGADMIN"."Q$_XOUT_1" 0.8 0.01 0 |<A> XOUT 0.4 0.2 0 PS+PR 0% "" APR  APC  APS (2) 0% "" |<B> NO BOTTLENECK IDENTIFIED
--
--
--PATH 1 RUN_ID 2 RUN_TIME 2025-AUG-13 12:10:31 CCA N|<C> CONFLUENT_XOUT1 102 0.25 1 LMP (0) CAP 0% "" |<Q> "C##GGADMIN"."Q$_XOUT_1" 0.25 0.01 0 |<A> XOUT 0.01 0.01 0 PS+PR 0% "" APR  APC  APS (2) 0% "" |<B> NO BOTTLENECK IDENTIFIED
