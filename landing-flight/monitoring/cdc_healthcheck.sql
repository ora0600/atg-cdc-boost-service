...
REM USAGE; 
REM sqlplus c##ggadmin@orclcdb
REM SQL> spool cdc-health.html
REM SQL> @cdc_healthcheck.sql
REM SQL> spool off
REM
connect sys/confluent123@orclcdb as sysdba
set markup HTML ON entmap off

alter session set nls_date_format='HH24:Mi:SS MM/DD/YY';
set heading off

select 'CDC XStream Configuration Check (V1.0.0) for '||global_name||' on Instance='||instance_name||' generated: '||sysdate o from global_name, v$instance;
