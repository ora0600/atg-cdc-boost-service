...
PROMPT ==== Capture SGA Usage: USED field is equal to or almost equal to the ALLOCATED increase SGA ====
...
PROMPT ==== Logminer Usage: If the PCT field is equal to or almost equal to 1 in the output, then you might need to increase the maximum SGA size ====
...
SELECT members, THREAD#, SEQUENCE#, FIRST_CHANGE#, NEXT_CHANGE#, STATUS
FROM V$LOG
ORDER BY THREAD#, SEQUENCE# DESC;

PROMPT ==== Archived Log Oldest and latest SCN ====
SELECT MIN(FIRST_CHANGE#) AS OLDEST_SCN, 
